...
clear
close all
load /home/user01/Kevin_Yu/3D_bridge_meshes/coverage/VTOL/outputs/journalQg1.mat
load /home/user01/Kevin_Yu/3D_bridge_meshes/coverage/VTOL/outputs/journalQg3.mat

% GLNSSolution = [281, 22, 323, 64, 365, 106, 127, 428, 169, 470, 211, 273, 535, 237, 561] % qualitative b (from qualitative b in old paper)
% GLNSSolution = [281, 23, 325, 67, 369, 111, 135, 438, 163, 466, 209, 276, 532, 237, 561] % qualitative c (from qualitative c in old paper)
% GLNSSolution = [281, 23, 325, 67, 369, 111, 122, 425, 168, 471, 481, 267, 532, 237, 561] % qualitative d (from qualitative d in old paper)
...
GLNSSolution = [561, 521, 229, 541, 210, 476, 441, 146, 412, 398, 82, 346, 50, 314, 18] % qualitative g (fixed-wing with down up edges)
