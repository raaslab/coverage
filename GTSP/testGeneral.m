...
[v_Adj, v_Type, S1, T1, weights, v_ClusterLevels,FDU,F] = makingSTWv_AdjGeneral(maxDistance, x1, y1, numPointsInit, numBatteryLevels, v_Cluster, timeTO, timeL, rechargeRate, UGVSpeed, groupedPoints);
